...
from catboost import to_classifier, Pool
...
def main():
    if upload_file is not None:
        ...
        cat_feat = ['email', 'ip', 'cardToken', 'paymentSystem', 'bankCountry', 'partyId', 'shopId', 'currency',
                    'bin_hash', 'ms_pan_hash', 'g1', 'g2', 'g3']
        pool = Pool(new_test, cat_features=cat_feat)
